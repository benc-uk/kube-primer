...
## Use kubectl exec to run commands inside a pod/container Use -it switch and sh or bash to create an interactive shell Use kubectl debug to attach to distroless containers or to create an interactive sidecar in a pod
