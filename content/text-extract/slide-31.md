...
## Kubernetes makes extensive use of labels and selectors Labels are metadata on any object and are just key+value pairs of your choosing Selectors are lookups that match one or more objects based on their labels
